	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if start, end := generateArroundPage(page, totalPage); true {
			...
			for i := start; i <= end; i++ {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `server/ui/layout_pagination.templ`, Line: 42, Col: 19}
				}
...
func paginationInfo(pg api.Pagination) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `server/ui/layout_pagination.templ`, Line: 90, Col: 15}
		}
