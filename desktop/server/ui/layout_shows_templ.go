...
func showBasicInfo(show api.Show) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var3 templ.SafeURL = getShowURL(show)
		...
		templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(show.PosterLink)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `server/ui/layout_shows.templ`, Line: 38, Col: 26}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `server/ui/layout_shows.templ`, Line: 67, Col: 38}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `server/ui/layout_shows.templ`, Line: 68, Col: 46}
		}
...
func label(text string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `server/ui/layout_shows.templ`, Line: 86, Col: 63}
		}
